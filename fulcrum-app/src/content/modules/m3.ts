...
export const m3: Module = {
  ...
  practice: [
    ...
    { kind: 'record', title: 'Calibration check', body: 'Record a meeting where you presented. Afterwards run a FULCRUM evaluation — it looks at whether you framed to the audience and responded to cues, or ran one script.' },
