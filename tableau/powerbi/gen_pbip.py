...
TABLES = {
 "Fact_Spend_Agg": [("ihg_flag","string"),("region","string"),("reporting_region","string"),
   ...
   ("hotels","int64"),("rooms_sum","int64"),("spend","double")],
 ...
 "Fact_CRF": [("region","string"),("month","dateTime"),("year","int64"),("crf_usd","double")],
 ...
 "Fact_Programme_Spend": [("hotel_code","string"),("hotel_name","string"),("company_region","string"),
...
model = {
 ...
 "model": {
   ...
   "relationships": [{
     ...
     "toTable": "Dim_Hotel", "toColumn": "InnCode",
