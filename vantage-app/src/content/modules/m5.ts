...
export const m5: Module = {
  ...
  title: 'Communication Architecture: Pyramid & BLUF',
  track: 'clarity',
  book: { part: 3, partTitle: 'Clarity and Influence — Presence, Architecture, and Persuasion', chapter: 5, chapterTitle: 'Communication Architecture — The Pyramid and the Premise' },
  ...
  keyTerms: [
    ...
    { term: 'Governing thought', def: 'The single point you want the listener to hold — the apex of the pyramid that everything beneath it supports.' },
  ...
  practice: [
    ...
    { kind: 'record', title: 'Time-to-point', body: 'Record an update and time how long until your main point lands. Then run a VANTAGE evaluation — it measures words-before-the-ask and structure markers.' },
