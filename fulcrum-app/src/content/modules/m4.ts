...
export const m4: Module = {
  ...
  practice: [
    ...
    { kind: 'record', title: 'Recovery speed', body: 'Record a likely-to-be-tense conversation. Afterwards, find the moment you got triggered and time how long until you recovered. A FULCRUM evaluation reads defensiveness and recovery for you.' },
