...
export const m9: Module = {
  ...
  practice: [
    ...
    { kind: 'record', title: 'Discovery check', body: 'Record a sales or pitch conversation. A FULCRUM evaluation reads your discovery depth, talk-time, whether you tied solution to need, and whether you closed.' },
