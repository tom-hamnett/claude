...
export const m12: Module = {
  ...
  track: 'practice',
  book: { part: 5, partTitle: 'Integration — Building the Skills That Stick', chapter: 12, chapterTitle: 'The Loop — Deliberate Practice and the Skills That Stick' },
  oneLiner: 'Turn feedback into one focus at a time, practised in real life, until it sticks.',
  estReadMin: 16,
  whyItMatters:
    'This is the module that makes all the others work — the book\'s final part and its integration engine. The reason training usually fails is the "transfer problem": people learn skills in a workshop that never show up in real meetings. The fix is not more content — it is a deliberate-practice loop run against your real conversations, with the After-Action Review as the learning engine. This module teaches you how to use VANTAGE (and feedback in general) so insight becomes habit, and habit becomes who you are.',
  learningObjectives: [
  ...
  keyTerms: [
    ...
    { term: 'After-Action Review', def: 'A short, structured debrief after a real conversation: what did I intend, what happened, what will I do differently next time.' },
  ...
  subAreas: ['Pattern recognition', 'Reflection / After-Action Review', 'Goal-setting', 'Practice planning', 'Targeted drills', 'Progress / trend review'],
  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'check',
          q: 'A VANTAGE report flags six things to improve. What\'s the best response?',
          options: [
  ...
  practice: [
    { kind: 'observe', title: 'Spot your pattern', body: 'Look across your last few VANTAGE evaluations (or reflect on recent conversations). What shows up repeatedly? That recurring thing is your focus.' },
    ...
    { kind: 'reflect', title: 'After-Action Review', body: 'After your next high-stakes conversation, run a two-minute AAR: what did I intend, what actually happened, what will I do differently next time?' },
  ],
  warningSigns: [
  ...
  furtherReading: ['Anders Ericsson — Peak (deliberate practice)', 'Kirkpatrick — levels of training evaluation', 'Lacerenza et al. — leadership-training transfer', 'CCL — 70-20-10 development', 'Charles Duhigg — The Power of Habit'],
  grounding: ['Ericsson (deliberate practice)', 'Kirkpatrick / Lacerenza (transfer)', 'CCL (70-20-10)', 'Duhigg (habit)'],
};
