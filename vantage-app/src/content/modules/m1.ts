...
export const m1: Module = {
  ...
  title: 'Emotional Regulation & the Choice-Point',
  track: 'presence',
  book: { part: 1, partTitle: 'The Foundation — Self-Regulation as the Prerequisite', chapter: 1, chapterTitle: 'The Choice-Point — Why You React and How to Stop' },
  oneLiner: 'Catch your triggers at the choice-point and respond on purpose, not on impulse.',
  estReadMin: 18,
  whyItMatters:
    'Every other skill in this curriculum — listening, clarity, hard conversations — becomes unavailable the moment you are emotionally hijacked. This is why the book opens here: self-regulation is the prerequisite for everything else. It is also the most private skill: nobody sees you do it, they only see the steadiness it produces. This module teaches the inner mechanics of staying composed and confident when it counts.',
  learningObjectives: [
  ...
  keyTerms: [
    { term: 'The choice-point', def: 'The gap between a stimulus (a challenge, a silence) and your response. Self-regulation is the practice of widening that gap so you can choose, rather than react.' },
    { term: 'Amygdala hijack', def: 'When the brain\'s threat system fires and floods you before the deliberate, thinking part can engage — the physiological basis of the reactive response.' },
  ...
  lessons: [
    {
      ...
      estMin: 7,
      blocks: [
        { type: 'p', md: 'Reactivity feels instant — someone questions your work and you\'re defending before you\'ve decided to. But it isn\'t instant. There is always a gap, however small, between the stimulus and your response. Self-regulation is the practice of finding that gap and standing in it long enough to choose. The book calls this the **choice-point**, and it is the idea every other chapter depends on.' },
  ...
  furtherReading: ['Oren Jay Sofer — Say What You Mean (presence, intention)', 'Crucial Conversations — Master My Stories', 'Daniel Goleman — Emotional Intelligence (the hijack)', 'Bates ExPI — Composure, Restraint'],
  grounding: ['Sofer — Say What You Mean', 'Crucial Conversations', 'Goleman (EQ)', 'Bates ExPI'],
};
