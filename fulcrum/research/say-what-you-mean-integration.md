...
This file records **what's in the database, how good it is, and exactly how it feeds the FULCRUM curriculum and the diagnostic rubric.**
...
| Foundation (Sofer) | Rows | Maps to FULCRUM track |
|---|---|---|
...
| Unit | Rows | Tool mix | FULCRUM home |
|---|---|---|---|
