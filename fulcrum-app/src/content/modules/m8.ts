...
export const m8: Module = {
  ...
  practice: [
    ...
    { kind: 'record', title: 'Trade & close check', body: 'Record a negotiation. A FULCRUM evaluation reads whether you surfaced interests, traded vs. conceded, handled objections calmly, and closed to a next step.' },
