    ...
    for (const file of list) {
      ...
      try {
        if (isBinaryKind(kind)) {
          ...
          // Pass the raw file; the service streams large media to Gemini and only base64s small inline files.
  ...
  return (
    <div className="space-y-5">
      ...
      >
        ...
        <p className="text-sm text-ink-400">Audio / video / PDF / images / CSV — FLUX picks the right model for each. Large media (up to ~2GB) streams to Gemini automatically.</p>
