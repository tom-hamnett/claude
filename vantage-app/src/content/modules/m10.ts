...
export const m10: Module = {
  ...
  estReadMin: 16,
  whyItMatters:
    'This is the module that makes all the others work. The reason training usually fails is the "transfer problem": people learn skills in a workshop that never show up in real meetings. The fix is not more content — it is a deliberate-practice loop run against your real conversations. This module teaches you how to use VANTAGE (and feedback in general) so that insight becomes habit, and habit becomes who you are.',
  learningObjectives: [
