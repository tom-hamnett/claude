...
export const m4: Module = {
  ...
  track: 'clarity',
  book: { part: 3, partTitle: 'Clarity and Influence — Presence, Architecture, and Persuasion', chapter: 4, chapterTitle: 'Executive Presence — What It Actually Is and How to Build It' },
  ...
  keyTerms: [
    ...
    { term: 'The choice-point', def: 'The gap between something happening (a challenge, a silence) and your response. Presence lives in widening that gap so you can choose (Module 1).' },
  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        { type: 'p', md: 'Notice what is *not* on the list: height, accent, extroversion, a deep voice, an expensive suit. Those are surface signals people sometimes mistake for presence — and treating them as the standard is exactly how "executive presence" becomes a biased, exclusionary code. VANTAGE scores effectiveness toward **your** goals in **your** style. Presence is behaviour, not costume.' },
        {
          type: 'callout',
          tone: 'key',
  ...
  practice: [
    ...
    { kind: 'record', title: 'Pressure tape', body: 'Record a meeting where you expect to be challenged or to present. Afterwards, find your three highest-pressure moments and ask: did I react, suppress, or stay grounded? Then run a VANTAGE evaluation and compare with its read of your pause length and pace under pressure.' },
