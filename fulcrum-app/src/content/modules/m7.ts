...
export const m7: Module = {
  ...
  practice: [
    ...
    { kind: 'record', title: 'Ask audit', body: 'Record a meeting where you needed something. A FULCRUM evaluation reads whether your asks were specific and doable, or vague/hinted, and whether you over-softened.' },
