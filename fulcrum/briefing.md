...
flowchart TD
    subgraph IN[" "]
      A["Best-in-class training, benchmarked<br/>Executive presence · Leadership · Communication<br/>Sales · Negotiation · Interpersonal"]
      B["Academic assessment science<br/>Bates ExPI · Spitzberg-Cupach · BARS · Kirkpatrick"]
      C["Say What You Mean database<br/>Sofer / NVC internal spine"]
    end
    A --> F
    B --> F
    C --> F
    F["THE FRAMEWORK<br/>Competency model + detailed BARS rubric<br/>(verbal + non-verbal)"]
    F --> L["LEARN — the curriculum<br/>14 modules across 4 tracks<br/>theory · principles · techniques · actionable practice"]
    F --> E["EVALUATE — the engine  ★ the invention ★<br/>Upload a real conversation →<br/>verbal + non-verbal analysis →<br/>holistic, self-only feedback vs. the framework"]
    E -->|"points you to the exact modules"| L
    L -->|"practise in real conversations, then re-upload"| E
    E --> O["ONGOING IMPROVEMENT<br/>specific feedback after real meetings<br/>progress visible over time (transfer, solved)"]
    O -.->|"repeat"| E
```
