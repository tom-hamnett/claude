...
export const m6: Module = {
  ...
  practice: [
    ...
    { kind: 'record', title: 'Heat check', body: 'Record (with consent) or debrief a tough conversation. A VANTAGE evaluation reads whether you opened safe, stayed composed under pushback, and used observation vs. evaluation.' },
