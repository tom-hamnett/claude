...
export const m11: Module = {
  ...
  furtherReading: ['Oren Jay Sofer — Say What You Mean (needs, requests)', 'Marshall Rosenberg — Nonviolent Communication', 'Bates ExPI — Assertiveness', 'Crucial Conversations'],
  grounding: ['Sofer / NVC', 'Rosenberg (NVC)', 'Bates ExPI', 'Crucial Conversations'],
};
